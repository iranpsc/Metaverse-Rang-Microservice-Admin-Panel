...
class TradedController extends Controller
{
    use AuthorizesAdminAccess;

    public function __construct()
    {
        $this->authorizeAdminAccess(['view-features-trades']);
    }

    /**
     * Get paginated traded lands
     *
    ...
    public function index(Request $request): JsonResponse
    {
        ...
        $query = Trade::with(['feature.properties', 'buyer', 'seller', 'commision'])
        ...
        return response()->json([
            ...
            'message' => 'Traded lands retrieved successfully.',
        ]);
    }
}
