    ...
    <div class="flex flex-col gap-4 md:flex-row md:items-center md:justify-between">
      <div>
        <PageHeader
          dense
          title="مجوزهای سطح"
          subtitle="مدیریت مجوزها و دسترسی‌های اختصاص‌یافته به سطح انتخاب‌شده در متاورس"
        />
...
import { Button, Card, Checkbox, LoadingState, ErrorState, PageHeader } from '../../components/ui'
