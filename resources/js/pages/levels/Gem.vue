    ...
    <div class="flex flex-col gap-4 md:flex-row md:items-center md:justify-between">
      <div>
        <PageHeader
          dense
          title="نگین سطح"
          subtitle="مدیریت ویژگی‌ها، فایل‌ها و رمزگذاری نگین اختصاص‌یافته به سطح انتخاب‌شده."
        />
      ...
      <div class="space-y-6">
        ...
        <Card variant="glass" padding="xl" rounded="lg">
          ...
          <FileUploadModal
            ...
            helper-text="فرمت‌های مجاز: bin, glb, gltf, png, jpeg, gif, jpg, fbx — حداکثر ۲۰ فایل، هر فایل تا ۳۰۰ مگابایت"
...
const fileDeleteUrl = computed(() => (
  levelId.value ? `/levels/${levelId.value}/gem/files` : ''
))
...
const hasFormChanges = () => {
  ...
  const fileChanged = Boolean(form.png_file || hasPendingFbxFiles.value)
