...
trait CreatesLevelLicenseApiSchema
{
    use CreatesCitizensApiSchema;

    protected function setUpLevelLicenseApiSchema(): void
    {
        $this->setUpCitizensApiSchema();
        $this->createLevelsTable();
        $this->createLevelLicensesTable();
    }
    ...
    private function createLevelLicensesTable(): void
    {
        if (Schema::hasTable('level_licenses')) {
            return;
        }
