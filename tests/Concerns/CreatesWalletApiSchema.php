...
trait CreatesWalletApiSchema
{
    protected function setUpWalletApiSchema(): void
    {
    ...
    private function createWalletsTable(): void
    {
        ...
        Schema::create('wallets', function (Blueprint $table) {
            ...
            $table->decimal('psc', 16, 4)->nullable()->default(0);
            $table->decimal('blue', 16, 4)->nullable()->default(0);
            $table->decimal('red', 16, 4)->nullable()->default(0);
            $table->decimal('yellow', 16, 4)->nullable()->default(0);
            $table->decimal('irr', 16, 4)->nullable()->default(0);
            $table->decimal('green', 16, 4)->nullable()->default(0);
            $table->decimal('satisfaction', 16, 4)->nullable();
            $table->decimal('effect', 16, 4)->nullable();
            $table->timestamps();
        });
    }
